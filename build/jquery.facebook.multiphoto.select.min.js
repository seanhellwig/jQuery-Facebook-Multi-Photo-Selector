...
if(0<a.length)for(e=0;e<a.length;e++){1===(e+1)%d.numPhotosColumns&&i.append('<div class="image-row" />');var b=c('<div id="fb-albumimage-'+a[e].id+'" class="jfmps-albumimage" />');b.data("image_id",a[e].id);void 0!==g[a[e].id]&&b.addClass("selected");var f=c('<img width="75" src="https://graph.facebook.com/'+a[e].id+"/picture?access_token="+FB.getSession().access_token+'&amp;type=thumbnail" />');b.append(f);c("div.image-row",i).last().append(b);B(b,a[e].images)}else i.append("<h2>"+d.noAlbumImagesText+
